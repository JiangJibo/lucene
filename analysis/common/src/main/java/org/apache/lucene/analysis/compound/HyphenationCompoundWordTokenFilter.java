...
public class HyphenationCompoundWordTokenFilter extends
   ...
   * <p>
   * Calls {@link #HyphenationCompoundWordTokenFilter(org.apache.lucene.analysis.TokenStream, HyphenationTree, org.apache.lucene.analysis.CharArraySet, int, int, int, boolean)
   ...
   * Create a HyphenationCompoundWordTokenFilter with no dictionary.
   * <p>
   * Calls {@link #HyphenationCompoundWordTokenFilter(org.apache.lucene.analysis.TokenStream, HyphenationTree, int, int, int)
   * HyphenationCompoundWordTokenFilter(matchVersion, input, hyphenator,
