        ...
        try {
            ...
            for (int i = 0; i < numFields; i++) {
                ...
                FieldReader previous = fields.put(fieldInfo.name,
                    new FieldReader(fieldInfo, numTerms, termsStartPointer, sumTotalTermFreq, sumDocFreq, docCount, longsSize));
                if (previous != null) {
    ...
    private class FieldReader extends Terms implements Accountable {
        ...
        private final class SegmentTermsEnum extends TermsEnum {
            ...
            public SeekStatus seekCeil(final BytesRef target) throws IOException {
                ...
                //System.out.println("BTR.seek seg=" + segment + " target=" + fieldInfo.name + ":" + target.utf8ToString() + " " + target + " current=" +
              // term().utf8ToString() + " " + term() + " indexIsCurrent=" + indexIsCurrent + " didIndexNext=" + didIndexNext + " seekPending=" + seekPending
