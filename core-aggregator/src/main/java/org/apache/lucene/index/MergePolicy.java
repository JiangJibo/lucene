...
public abstract class MergePolicy {
    ...
    public static class OneMerge {
        ...
        /**
         * 是否注册到 {@link IndexWriter#pendingMerges}
         */
         ...
         * 预计当前segment会有多少字节,已经减去的delete的doc
         */
        ...
        /**
         * Segments to be merged. 有哪些segment的提交点
         */
     ...
     */
    protected final boolean isMerged(SegmentInfos infos, SegmentCommitInfo info, IndexWriter writer)
        throws IOException {
        assert writer != null;
