...
public abstract class DirectoryReader extends BaseCompositeReader<LeafReader> {
     ...
     */
    public static DirectoryReader open(final IndexWriter writer, boolean applyAllDeletes, boolean writeAllDeletes)
        throws IOException {
    ...
    /**
     * 如果索引从上次Reader打开后发生了变化, 那么返回一个新的Reader, 否则返回null
