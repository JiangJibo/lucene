...
abstract class FSTEnum<T> {
    ...
    protected void doNext() throws IOException {
        ...
        if (upto == 0) {
            ...
            // pop
            //System.out.println("  check pop curArc target=" + arcs[upto].target + " label=" + arcs[upto].label + "
          // isLast?=" + arcs[upto].isLast());
    ...
    protected void doSeekCeil() throws IOException {
        ...
        while (true) {
            ...
            //System.out.println("  cycle upto=" + upto + " arc.label=" + arc.label + " (" + (char) arc.label + ") vs
          // targetLabel=" + targetLabel);
            ...
            if (arc.bytesPerArc != 0 && arc.label != -1) {
                ...
                while (low <= high) {
                    ...
                    //System.out.println("  cycle low=" + low + " high=" + high + " mid=" + mid + " midLabel=" +
                  // midLabel + " cmp=" + cmp);
                ...
                if (found) {
                    ...
                    while (true) {
                        ...
                        //System.out.println("  rollback upto=" + upto + " arc.label=" + prevArc.label + " isLast?="
                      // + prevArc.isLast());
                        if (!prevArc.isLast()) {
    ...
    protected void doSeekFloor() throws IOException {
        ...
        // Now scan forward, matching the new suffix of the target
        while (true) {
            //System.out.println("  cycle upto=" + upto + " arc.label=" + arc.label + " (" + (char) arc.label + ")
          // targetLabel=" + targetLabel + " isLast?=" + arc.isLast() + " bba=" + arc.bytesPerArc);
            ...
            if (arc.bytesPerArc != 0 && arc.label != FST.END_LABEL) {
                ...
                if (arc.label == targetLabel) {
                    ...
                    //System.out.println("  check next label=" + fst.readNextArcLabel(arc) + " (" + (char) fst
                  // .readNextArcLabel(arc) + ")");
