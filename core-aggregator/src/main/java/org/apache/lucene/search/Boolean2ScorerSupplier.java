...
final class Boolean2ScorerSupplier extends ScorerSupplier {
    ...
    /**
     * Create a new scorer for the given required clauses. Note that {@code requiredScoring} is a subset of {@code required} containing required clauses that
     * should participate in scoring.
     */
