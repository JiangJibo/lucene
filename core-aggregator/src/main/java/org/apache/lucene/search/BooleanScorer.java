...
/**
 * {@link BulkScorer} that is used for pure disjunctions and disjunctions that have low values of {@link BooleanQuery.Builder#setMinimumNumberShouldMatch(int)}
...
final class BooleanScorer extends BulkScorer {
    ...
    private void scoreWindowMultipleScorers(LeafCollector collector, Bits acceptDocs, int windowBase, int windowMin, int windowMax, int maxFreq)
        throws IOException {
