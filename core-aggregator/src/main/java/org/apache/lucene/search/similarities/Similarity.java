 ...
 * be later accessible via {@link org.apache.lucene.index.LeafReader#getNormValues(String)}.  Lucene makes no
 * assumption
 ...
 * <li>For each segment in the index, the Query creates a {@link #simScorer(SimWeight,
 ...
 * When {@link IndexSearcher#explain(org.apache.lucene.search.Query, int)} is called, queries consult the Similarity's
 * DocScorer for an
 * explanation of how it computed its score. The query passes in a the document id and an explanation of how the
 * frequency
 * was computed.
 *
 * @lucene.experimental
