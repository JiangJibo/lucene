...
/**
 * Specialization for a disjunction over many terms that behaves like a {@link ConstantScoreQuery} over a {@link BooleanQuery} containing only {@link
 ...
 * However, when there are many terms, instead of merging iterators on the fly, it will populate a bit set with matching docs and return a {@link Scorer} over
 * this bit set.
