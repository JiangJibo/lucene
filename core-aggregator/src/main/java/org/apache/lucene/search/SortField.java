...
public class SortField {
    ...
    /**
     * Specifies the type of the terms to be sorted, or special types such as CUSTOM 对结果集做排序时可以指定哪些类型, 比如 SCORE:关联性评分; DOC: docId
     */
    public static enum Type {
        ...
        /**
         * Force rewriting of SortField using {@link SortField#rewrite(IndexSearcher)} before it can be used for sorting
         */
        REWRITEABLE
    }
    ...
    /**
     * Return the value to use for documents that don't have a value. A value of {@code null} indicates that default should be used.
     */
    ...
    /**
     * Returns true if <code>o</code> is equal to this.  If a {@link FieldComparatorSource} was provided, it must properly implement equals (unless a singleton
     * is always used).
     */
    @Override
    ...
    /**
     * Returns a hash code for this {@link SortField} instance.  If a {@link FieldComparatorSource} was provided, it must properly implement hashCode (unless a
     ...
     * @param sortPos position of this SortField within {@link Sort}.  The comparator is primary if sortPos==0, secondary if sortPos==1, etc.  Some comparators
     *                can optimize themselves when they are the primary sort.
    ...
    /**
     * Rewrites this SortField, returning a new SortField if a change is made. Subclasses should override this define their rewriting behavior when this
