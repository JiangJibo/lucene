...
public abstract class BufferedIndexInput extends IndexInput implements RandomAccessInput {
    ...
    public final void setBufferSize(int newSize) {
        assert buffer == null || bufferSize == buffer.length : "buffer=" + buffer + " bufferSize=" + bufferSize
        ...
        if (newSize != bufferSize) {
            ...
            if (buffer != null) {
                ...
                final int numToCopy;
                if (leftInBuffer > newSize) { numToCopy = newSize; } else { numToCopy = leftInBuffer; }
    ...
    public final void seek(long pos) throws IOException {
        // 如果当前chunk已经查找过了, 缓存了start和length
