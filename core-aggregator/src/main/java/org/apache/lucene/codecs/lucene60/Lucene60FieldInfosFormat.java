...
public final class Lucene60FieldInfosFormat extends FieldInfosFormat {
    ...
    /**
     * 读取segment里的fieldInfo, 7.0以后从cfs文件里读取,之前从.fnm文件里读取
     *
     * @param directory
     * @param segmentInfo
     * @param segmentSuffix
    ...
    public FieldInfos read(Directory directory, SegmentInfo segmentInfo, String segmentSuffix, IOContext context) throws IOException {
        ...
        // / 获取filedInfo信息的文件,如果是复合文件,则返回 _N.cfs;  如果不是复合文件,则返回 _N.fnm , N是对应的segment 文件序号-1
        ...
        try (ChecksumIndexInput input = directory.openChecksumInput(fileName, context)) {
            ...
            try {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    // DV Types are packed in one byte, 获取此field的
    ...
    public void write(Directory directory, SegmentInfo segmentInfo, String segmentSuffix, FieldInfos infos, IOContext context) throws IOException {
        ...
        try (IndexOutput output = directory.createOutput(fileName, context)) {
            CodecUtil.writeIndexHeader(output, Lucene60FieldInfosFormat.CODEC_NAME, Lucene60FieldInfosFormat.FORMAT_CURRENT, segmentInfo.getId(),
                segmentSuffix);
